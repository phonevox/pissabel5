...
```bash
sudo yum update -y && sudo yum install -y tmux git && tmux new -s issabel-tmux "git clone https://github.com/phonevox/pissabel5.git && cd pissabel5 && chmod +x issabel5-netinstall.sh && ./issabel5-netinstall.sh"
```
